...
import org.monte.screenrecorder.CommandlineRecorderMain;
...
public class ScreenRecorder {
    ...
    public static void main(String[] args) {
        ...
        String quicktimePath = args[0];
        
        CommandlineRecorderMain rec = new CommandlineRecorderMain();
        rec.main(quicktimePath);        
    }
